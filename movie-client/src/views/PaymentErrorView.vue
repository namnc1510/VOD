...
import { getPaymentMethods } from '../data/showcase';
...
const recoveryHints = [
  'Kiem tra lai han muc the hoac so du tai khoan.',
  'Thu lai bang VNPAY QR neu giao dich the bi tu choi.',
  'Neu redirect bi gian doan, quay lai trang pricing va tao checkout moi.'
];
</script>
      ...
      <div class="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div class="space-y-5">
          ...
          <div class="grid gap-3">
            ...
            >
              <p class="text-sm font-bold text-slate-700 dark:text-slate-200">{{ hint }}</p>
            </article>
          </div>
